...
--
-- Name: geocodes_city; Type: TABLE; Schema: public; Owner: idstore
--

CREATE TABLE public.geocodes_city (
    id_city integer NOT NULL,
    code_country character varying(10) DEFAULT ''::character varying NOT NULL,
    code character varying(10) DEFAULT ''::character varying NOT NULL,
    code_zone character varying(10) DEFAULT ''::character varying NOT NULL,
    name character varying(255) DEFAULT ''::character varying NOT NULL
);


ALTER TABLE public.geocodes_city OWNER TO idstore;

--
-- Name: geocodes_city_id_city_seq; Type: SEQUENCE; Schema: public; Owner: idstore
--

CREATE SEQUENCE public.geocodes_city_id_city_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.geocodes_city_id_city_seq OWNER TO idstore;

--
-- Name: geocodes_city_id_city_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: idstore
--

ALTER SEQUENCE public.geocodes_city_id_city_seq OWNED BY public.geocodes_city.id_city;


--
-- Name: geocodes_country; Type: TABLE; Schema: public; Owner: idstore
--
...
ALTER TABLE public.geocodes_country OWNER TO idstore;

--
-- Name: geocodes_country_id_country_seq; Type: SEQUENCE; Schema: public; Owner: idstore
--

CREATE SEQUENCE public.geocodes_country_id_country_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.geocodes_country_id_country_seq OWNER TO idstore;

--
-- Name: geocodes_country_id_country_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: idstore
--

ALTER SEQUENCE public.geocodes_country_id_country_seq OWNED BY public.geocodes_country.id_country;
...
--
-- Name: geocodes_city id_city; Type: DEFAULT; Schema: public; Owner: idstore
--

ALTER TABLE ONLY public.geocodes_city ALTER COLUMN id_city SET DEFAULT nextval('public.geocodes_city_id_city_seq'::regclass);


--
-- Name: geocodes_country id_country; Type: DEFAULT; Schema: public; Owner: idstore
--

ALTER TABLE ONLY public.geocodes_country ALTER COLUMN id_country SET DEFAULT nextval('public.geocodes_country_id_country_seq'::regclass);
...
--
-- Name: geocodes_city_id_city_seq; Type: SEQUENCE SET; Schema: public; Owner: idstore
--

SELECT pg_catalog.setval('public.geocodes_city_id_city_seq', 37742, true);


--
-- Name: geocodes_country_id_country_seq; Type: SEQUENCE SET; Schema: public; Owner: idstore
--

SELECT pg_catalog.setval('public.geocodes_country_id_country_seq', 57, true);
...
--
-- Name: geocodes_city geocodes_city_pkey; Type: CONSTRAINT; Schema: public; Owner: idstore
--

ALTER TABLE ONLY public.geocodes_city
    ADD CONSTRAINT geocodes_city_pkey PRIMARY KEY (id_city);


--
-- Name: geocodes_country geocodes_country_pkey; Type: CONSTRAINT; Schema: public; Owner: idstore
--

ALTER TABLE ONLY public.geocodes_country
    ADD CONSTRAINT geocodes_country_pkey PRIMARY KEY (id_country);
...
--
-- Name: idx_city_code; Type: INDEX; Schema: public; Owner: idstore
--

CREATE INDEX idx_city_code ON public.geocodes_city USING btree (code);


--
-- Name: idx_city_name; Type: INDEX; Schema: public; Owner: idstore
--

CREATE INDEX idx_city_name ON public.geocodes_city USING btree (name);


--
-- Name: idx_country_code; Type: INDEX; Schema: public; Owner: idstore
--

CREATE INDEX idx_country_code ON public.geocodes_country USING btree (code);


--
-- Name: idx_country_code_cities; Type: INDEX; Schema: public; Owner: idstore
--

CREATE INDEX idx_country_code_cities ON public.geocodes_city USING btree (code_country);


--
-- Name: idx_country_name; Type: INDEX; Schema: public; Owner: idstore
--

CREATE INDEX idx_country_name ON public.geocodes_country USING btree (name);
